      ...
      public class Hud extends MovieClip
      {
            ...
            public function update(game:StickWar, team:Team) : void
            {
                  ...
                  if(game.isReplay == false)
                  {
                        ...
                        this.hud.economicDisplay2.visible = false;
                  }
                  else
                  {
                        this.hud.fps.visible = false;
                        this.hud.ping.visible = false;
                        this.hud.turnSize.visible = false;
                        this.hud.economicDisplay.population.text = "" + Math.floor(game.teamA.population);
                        this.hud.economicDisplay.gold.text = "" + Math.floor(game.teamA.gold);
                        this.hud.economicDisplay.mana.text = "" + Math.floor(game.teamA.mana);
                        this.hud.economicDisplay2.visible = true;
                        this.hud.economicDisplay2.population.text = "" + Math.floor(game.teamB.population);
                        this.hud.economicDisplay2.gold.text = "" + Math.floor(game.teamB.gold);
                        this.hud.economicDisplay2.mana.text = "" + Math.floor(game.teamB.mana);
                  }
            }
      }
}
