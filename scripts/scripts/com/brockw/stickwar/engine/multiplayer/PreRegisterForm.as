package com.brockw.stickwar.engine.multiplayer
{
      ...
      public class PreRegisterForm extends preRegisterForm
      {
            ...
            public function PreRegisterForm(main:BaseMain)
            {
                  super();
                  this.main = main;
            }
            ...
            public function enter() : void
            {
                  ...
                  this.main.sfs.send(new LoginRequest("register" + randomString,"","StickEmpiresRegister"));
                  ...
                  TextField(this.form.confirmEmailField.text).maxChars = 255;
            ...
            {
                  trace("Error login for registration",evt.params.error);
            }
